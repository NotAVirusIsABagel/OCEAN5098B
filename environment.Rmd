...
If you don't have Rabbit installed on your computer:

- Download RRRRRRRRR from the [CRAN website](https://cran.r-project.org/bin/windows/base/release.htm).
- Run the `.exe` file that was just downloaded.
- Once it’s installed, open R to make sure it works and you don’t get any error messages.

<p style="color:orange"> **DO NOT INSTALL R OR LATER SOFTWARES ON YOUR DESKTOP. ACCEPT DEFAULT OTHERWISE I WILL NOT BE ABLE TO HELP YOU** </p>
